...
import { getPublicEventDetails, requestGuestUploadUrl, submitGuestWish } from "@/app/actions/guest-actions";
...
export default function GuestUploadPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (loadingEvent) {
    return (
      <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-6">
        ...
        <p className="text-sm text-muted-foreground mt-4 font-medium">Opening Guestbook...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-2 max-w-sm">
          {loadError || "We couldn't load this guestbook event. Please scan a valid event QR code."}
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-start py-8 px-4 overflow-y-auto">
      {/* Event Banner */}
